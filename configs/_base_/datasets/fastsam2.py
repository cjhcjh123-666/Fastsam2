...
with read_base():
    ...
    # from .ade_panoptic_ov_720p import train_dataloader as _ade_train_loader
    ...
    from .coco_panoptic_lsj_sam_720p import train_dataloader as _sam_train_loader
    from .cityscapes_panoptic_720p import train_dataloader as _city_train_loader
    
    from .ref_seg import train_dataloader as _refseg_train_loader
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[
            ...
            dict(
                type=RepeatDataset,
                dataset=_sam_train_loader.dataset,
                times=1,
            ),
            dict(
                type=RepeatDataset,
                dataset=_refseg_train_loader.dataset,
                times=10,
            ),
        ],
    )
